...
export type ChatStateWithPhaseOne = ChatState & {
...
export function getPhaseOneState(state: ChatStateWithPhaseOne): ChatPhaseOneStateSlice {
...
export function withPhaseOneState(
  ...
  return {
    ...(state as ChatStateWithPhaseOne),
    phaseOne: {
      ...phaseOne,
