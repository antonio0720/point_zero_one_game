...
import {
  ...
  type ChatTelemetrySinkFlushReason as ChatTelemetryFlushReason,
...
export function parseStreamRecordFromUnknown(value: unknown): ChatEventStreamRecord {
  ...
  return {
    ...
    eventId: readNullableString(value['eventId']) as Nullable<ChatEventId>,
    ...
    linkedMessageIds: freezeStringArray(value['linkedMessageIds']) as readonly ChatMessageId[],
    linkedReplayIds: freezeStringArray(value['linkedReplayIds']) as readonly ChatReplayId[],
    linkedProofEdgeIds: freezeStringArray(value['linkedProofEdgeIds']) as readonly ChatProofEdgeId[],
    linkedInferenceIds: freezeStringArray(value['linkedInferenceIds']) as readonly ChatInferenceId[],
...
export function buildTelemetryTimelineEntryFromEnvelope(
  ...
  return {
    ...
    urgency: deriveUrgency(envelope),
