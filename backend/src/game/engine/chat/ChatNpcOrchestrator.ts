...
export function createNpcWatchBus(): ChatNpcWatchBus {
  return new ChatNpcWatchBus();
}

export function createNpcEpochTracker(): ChatNpcOrchestrationEpochTracker {
  return new ChatNpcOrchestrationEpochTracker();
}

export function describeNpcModule(): string {
  return `${CHAT_NPC_ORCHESTRATOR_MODULE_ID}@${CHAT_NPC_ORCHESTRATOR_MODULE_VERSION}`;
}

export const ChatNpcOrchestratorModule = Object.freeze({
  moduleId: CHAT_NPC_ORCHESTRATOR_MODULE_ID,
  version: CHAT_NPC_ORCHESTRATOR_MODULE_VERSION,
  descriptor: CHAT_NPC_ORCHESTRATOR_MODULE_DESCRIPTOR,
  HELPER_PERSONAS,
  ...
  createNpcAuthority,
  createNpcContext,
  createDefaultNpcLogger,
  createDefaultNpcClock,
  createDefaultNpcRandom,
  createDefaultNpcIds,
  planNpcTurn,
  evaluateNpcSuppression,
  planHelperResponse,
  computeHelperUrgency,
  chooseHelperPersona,
  scoreHelperPersona,
  resolveHelperChannelId,
  createHelperCandidate,
  composeHelperLine,
  maybeWrapHelperVoiceprint,
  createHelperFollowups,
  createHelperSceneIfNeeded,
  resolveHelperPriority,
  resolveHelperDelayMs,
  resolveHelperFollowupDelayMs,
  shouldCreateHelperFollowup,
  scoreHelperRescueWindow,
  scoreAffectDimension,
  scoreSilenceRisk,
  scoreShieldEmergency,
  deriveHelperTactic,
  rejectHelperPlan,
  planAmbientResponse,
  chooseAmbientTactic,
  chooseAmbientPersona,
  scoreAmbientPersona,
  resolveAmbientChannelId,
  createAmbientCandidate,
  composeAmbientLine,
  resolveAmbientPriority,
  resolveAmbientDelayMs,
  shouldAmbientBecomeScene,
  createAmbientScene,
  rejectAmbientPlan,
  selectNpcWinner,
  rejectNpcSelection,
  applyNpcPlan,
  maintainNpcArtifacts,
  toHaterTrigger,
  resolveNpcRuntime,
  resolveCurrentTargetUserId,
  createHelperSilence,
  createHaterSilence,
  chooseLine,
  createHelperPersona,
  createAmbientPersona,
  asScore01,
  normalizeOutboundText,
  randomBase36,
  describeNpcPlan,
  ChatNpcWatchBus,
  computeNpcOrchestrationFingerprint,
  ChatNpcOrchestrationEpochTracker,
  countNpcRoleFrequency,
  runNpcOrchestrationBatch,
  buildNpcSuppressionReport,
  npcSignalHasBattle,
  npcSignalHasEconomy,
  npcSignalHasPresence,
  npcSignalRoomId,
  npcSignalEventId,
  npcAudienceIsHot,
  npcAudienceHeatLabel,
  npcAffectIsFrustrated,
  npcAffectIsEmbarrassed,
  npcAffectIsConfident,
  npcHelperReceptivityHigh,
  npcHelperReceptivityLow,
  npcRoomHasActiveInvasion,
  npcRoomIsSilenced,
  npcRoomVisibleMessages,
  npcRoomInferenceSnapshots,
  npcRoomLearningProfile,
  npcRoomPresence,
  npcRoomAudienceHeat,
  npcApplyScene,
  npcApplySilence,
  ...
  npcPersonaLabel,
  npcPersonaChannels,
  npcPersonaSupportsChannel,
  npcSortCandidates,
  npcTopCandidate,
  npcCandidateHasBody,
  haterAuthorityIsReady,
  buildHaterTriggerFromSignal,
  describeHaterPlan,
  haterOptionsWithDefaults,
  npcRoomKindIsCompetitive,
  npcRoomKindIsRelaxed,
  npcStageMoodLabel,
  npcStageMoodIsTense,
  npcStageMoodIsHostile,
  npcChannelLabel,
  npcChannelIsPublic,
  npcRuntimeChannelAllowed,
  npcRuntimeRoomKindAllowed,
  npcClampScore,
  npcTimestamp,
  npcIsNullable,
  createNpcWatchBus,
  createNpcEpochTracker,
  describeNpcModule,
} as const);
