...
export class TickStateLock {
  ...
  private assertTransitionAllowed(
    ...
    const allowed: Readonly<Record<RunLifecycleState, readonly RunLifecycleState[]>> = Object.freeze({
      IDLE: Object.freeze(['STARTING', 'IDLE']),
      STARTING: Object.freeze(['ACTIVE', 'ENDING', 'IDLE']),
      ACTIVE: Object.freeze(['TICK_LOCKED', 'ENDING', 'ACTIVE']),
      TICK_LOCKED: Object.freeze(['ACTIVE', 'ENDING']),
      ENDING: Object.freeze(['ENDED', 'IDLE']),
      ENDED: Object.freeze(['IDLE', 'STARTING', 'ENDED']),
    });
