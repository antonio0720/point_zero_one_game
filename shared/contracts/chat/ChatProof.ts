...
export type ChatProofHash = ChatEventsModule.ChatProofHash;
export type ChatMessageId = ChatEventsModule.ChatMessageId;
export type ChatSessionId = ChatEventsModule.ChatSessionId;
export type ChatUserId = ChatEventsModule.ChatUserId;
export type ChatNpcId = ChatEventsModule.ChatNpcId;
export type ChatRequestId = ChatEventsModule.ChatRequestId;
export type ChatAuthority = ChatEventsModule.ChatAuthority;
export type ChatRange = ChatEventsModule.ChatRange;
export type ChatReplayId = ChatEventsModule.ChatReplayId;
export type ChatTelemetryId = ChatEventsModule.ChatTelemetryId;
export type ChatLegendId = ChatEventsModule.ChatLegendId;
export type ChatMemoryAnchorId = ChatEventsModule.ChatMemoryAnchorId;
export type ChatOfferId = ChatEventsModule.ChatOfferId;
export type ChatWorldEventId = ChatEventsModule.ChatWorldEventId;
export type ChatInterventionId = ChatEventsModule.ChatInterventionId;
...
export type ChatTelemetryEnvelope = ChatEventsModule.ChatTelemetryEnvelope;
