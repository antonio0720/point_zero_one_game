/**
 * ============================================================================
 * POINT ZERO ONE — FRONTEND CHAT EPISODIC MEMORY
 * FILE: pzo-web/src/engines/chat/intelligence/ChatEpisodicMemory.ts
 * ============================================================================
 *
 * Purpose
 * -------
 * Stores emotionally significant player / bot / crowd moments so frontend chat
 * can feel like it remembers the player even before backend truth replays land.
 * ============================================================================
 */
