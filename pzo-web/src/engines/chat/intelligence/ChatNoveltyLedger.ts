/**
 * ============================================================================
 * POINT ZERO ONE — FRONTEND CHAT NOVELTY LEDGER
 * FILE: pzo-web/src/engines/chat/intelligence/ChatNoveltyLedger.ts
 * ============================================================================
 *
 * Purpose
 * -------
 * Tracks perceived repetition and novelty at the frontend pacing layer.
 ...
 * It protects local emotional experience and candidate ranking.
 * ============================================================================
 */
