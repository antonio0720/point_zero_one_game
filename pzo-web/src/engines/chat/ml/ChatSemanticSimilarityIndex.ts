/**
 * ============================================================================
 * POINT ZERO ONE — FRONTEND CHAT SEMANTIC SIMILARITY INDEX
 * FILE: pzo-web/src/engines/chat/ml/ChatSemanticSimilarityIndex.ts
 ...
 *
 * The frontend copy is advisory. It exists so candidate ranking, immediate UI
 * cadence, and local anti-fatigue checks can happen before authoritative
 * backend ranking arrives.
 * ============================================================================
 */
