...
// ─── buildContextDigestMessages (patched event loop + sabotage block) ─────────
...
// ─── buildTranscriptSearchResult (patched) ───────────────────────────────────
