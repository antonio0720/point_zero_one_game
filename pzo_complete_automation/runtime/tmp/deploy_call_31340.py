...
out_path  = """scripts/pzo/session_01_session_1_engine_upgrade_part_1_phase_1a.sh"""
spec      = """Executable session script (safe: fail-fast, prints commands, optional DRY_RUN=1)"""
ext       = """sh"""
