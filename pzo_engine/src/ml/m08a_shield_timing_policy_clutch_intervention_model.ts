...
/** Extended output — M08A-specific signals */
 ...
 * runM08aMl
 *
 * Async — fires after core exec_hook (M08), reads output, returns advisory signals.
 ...
 * @returns         - M08AOutput + signed audit_hash
 */
...
// □ tier === 'policy_rl' → Constrained contextual bandit / offline RL (decision routing + bounded nudges)
  ...
  //
  // ─────────────────────────────────────────────────────────────────────────
  throw new Error('M08A (Shield Timing Policy (Clutch Intervention Model)) ML inference is not yet implemented.');
}

// ── Degraded mode fallback ────────────────────────────────────────────────────
/**
 * M08AFallback — rule-based fallback when ML is unavailable.
 * Must never throw; must return a valid (degraded) M08AOutput.
