...
/** Extended output — M113A-specific signals */
 ...
 * runM113aMl
 *
 * Async — fires after core exec_hook (M113), reads output, returns advisory signals.
 ...
 * @returns         - M113AOutput + signed audit_hash
 */
...
// □ tier === 'graph_dl' → GNN over contract / market / ledger graphs (relationship-aware, higher cost)
  ...
  //
  // ─────────────────────────────────────────────────────────────────────────
  throw new Error('M113A (Order Priority Stack Sacrifice Planner (Graph-Aware)) ML inference is not yet implemented.');
}

// ── Degraded mode fallback ────────────────────────────────────────────────────
/**
 * M113AFallback — rule-based fallback when ML is unavailable.
 * Must never throw; must return a valid (degraded) M113AOutput.
