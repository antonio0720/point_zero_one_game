...
/** Extended output — M143A-specific signals */
 ...
 * runM143aMl
 *
 * Async — fires after core exec_hook (M143), reads output, returns advisory signals.
 ...
 * @returns         - M143AOutput + signed audit_hash
 */
...
// □ tier === 'policy_rl' → Constrained contextual bandit / offline RL (decision routing + bounded nudges)
  ...
  //
  // ─────────────────────────────────────────────────────────────────────────
  throw new Error('M143A (Table Penalties Brigading Detector + Toxicity Classifier) ML inference is not yet implemented.');
}

// ── Degraded mode fallback ────────────────────────────────────────────────────
/**
 * M143AFallback — rule-based fallback when ML is unavailable.
 * Must never throw; must return a valid (degraded) M143AOutput.
