...
/** Extended output — M140A-specific signals */
 ...
 * runM140aMl
 *
 * Async — fires after core exec_hook (M140), reads output, returns advisory signals.
 ...
 * @returns         - M140AOutput + signed audit_hash
 */
...
// □ tier === 'sequence_dl' → TCN / Transformer encoder over event streams (higher accuracy, sequential patterns)
  ...
  //
  // ─────────────────────────────────────────────────────────────────────────
  throw new Error('M140A (Player Evidence Export Redaction Assistant + Packet Summarizer) ML inference is not yet implemented.');
}

// ── Degraded mode fallback ────────────────────────────────────────────────────
/**
 * M140AFallback — rule-based fallback when ML is unavailable.
 * Must never throw; must return a valid (degraded) M140AOutput.
